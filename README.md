...
* 5. 集合框架 （第 04 篇） 精尽源码分析：Map<K, V>接口与其内部接口Entry<K,V>

* [5. 集合框架 （第 05 篇） 精尽源码分析：jdk1.7版 HashMap](https://github.com/about-cloud/JavaCore/blob/dev/resource/markdown/collection/HashMap1.7v.md)
* 6. 集合框架 （第 06 篇） 精尽源码分析：jdk1.7版 ConcurrentHashMap
* 7. 集合框架 （第 07 篇） 精尽源码分析：二叉树、平衡二叉树、二叉查找树、AVL树、红黑树 概念
* 8. 集合框架 （第 08 篇） 精尽源码分析：jdk1.8版 HashMap
* 9. 集合框架 （第 09 篇） 精尽源码分析：jdk1.8版 ConcurrentHashMap
* 10. 集合框架 （第 10 篇） 精尽源码分析：LinkedHashMap
* 11. 集合框架 （第 11 篇） 精尽源码分析：TreeMap
* 12. 集合框架 （第 12 篇） 精尽源码分析：Set<E> 集合
* 13. 集合框架 （第 13 篇） 精尽源码分析：BlockingQueue 接口
* 14. 集合框架 （第 14 篇） 精尽源码分析：CopyOnWriteArrayList 与 CopyOnWriteArraySet
...
* 4. Java虚拟机 （第 04 篇） 深入理解：垃圾收集器
* 5. Java虚拟机 （第 05 篇） 深入理解：jdk内存分析命令
* 6. Java虚拟机 （第 06 篇） 深入理解：内存调优
* 7. Java虚拟机 （第 07 篇） 深入理解：死锁、CPU飙升与OOM排除过程
* 8. Java虚拟机 （第 08 篇） 深入理解：类文件结构
* 9. Java虚拟机 （第 09 篇） 深入理解：类加载机制
* 10. Java虚拟机 （第 10 篇） 深入理解：类加载的双亲委派模型
* 11. Java虚拟机 （第 11 篇） 深入理解：打破双亲委派模型
...
* 4. Java多线程与并发框 （第 04 篇） 深入理解：重排序、屏障指令、as-if-serial、happens-before规则
* 5. Java多线程与并发框 （第 05 篇） 深入理解：顺序一致性模型
* 6. Java多线程与并发框 （第 06 篇） 深入理解：volatile 关键字
* 7. Java多线程与并发框 （第 07 篇） 深入理解：synchronized 关键字
* 8. Java多线程与并发框 （第 08 篇） 深入理解：final 关键字
* 9. Java多线程与并发框 （第 09 篇） 深入理解：锁
* 10. Java多线程与并发框 （第 10 篇） 深入理解：无锁化 CAS
* 11. Java多线程与并发框 （第 11 篇） 深入理解：同步队列器 AQS
* 12. Java多线程与并发框 （第 12 篇） 深入理解：并发辅助工具类
* 13. Java多线程与并发框 （第 13 篇） 深入理解：定时器
* 14. Java多线程与并发框 （第 14 篇） 深入理解：ForkJoin框架
* 15. Java多线程与并发框 （第 15 篇） 深入理解：原子操作
* 16. Java多线程与并发框 （第 16 篇） 深入理解：线程池
...
* 4. 网络协议 （第 01 篇） 精讲：Get和Post方法的区别
* 5. 网络协议 （第 01 篇） 精讲：TCP和UPD的区别与对比
* 6. 网络协议 （第 01 篇） 精讲：TCP三次握手与四次挥手
* 7. 网络协议 （第 01 篇） 精讲：滑动窗口协议
...
* 4. Spring 5.x （第 01 篇） 核心篇：依赖注入的问题 -- 循环依赖
* 4. Spring 5.x （第 01 篇） 核心篇：Spring三个重要的框架级接口
* 5. Spring 5.x （第 01 篇） 核心篇：BeanFactory
* 6. Spring 5.x （第 01 篇） 核心篇：ApplicationContext
* 5. Spring 5.x （第 01 篇） 核心篇：Bean的生命周期
* 6. Spring 5.x （第 01 篇） 核心篇：Bean作用域
* 6. Spring 5.x （第 01 篇） 核心篇：AOP织入代码
...
* 4. MyBatis3 （第 01 篇）精尽源码分析：DefaultSqlSessionFactory
* 5. MyBatis3 （第 01 篇）精尽源码分析：SqlSessionFactoryBuilder
* 6. MyBatis3 （第 01 篇）精尽源码分析：XmlConfigBuilder
* 6. MyBatis3 （第 01 篇）精尽源码分析：StatementHandler
* 7. MyBatis3 （第 01 篇）精尽源码分析：ResultSetHandler
...
* 4. SpringBoot2.x （第 08 篇）精尽源码分析：spring-boot-starter-actuator 应用“监控”
* 5. SpringBoot2.x （第 09 篇）精尽源码分析：服务注册与发行
* 6. SpringBoot2.x （第 10 篇）精尽源码分析：监控与安防
* 7. SpringBoot2.x （第 11 篇）精尽源码分析：Spring的容器IOC
* 8. SpringBoot2.x （第 12 篇）精尽源码分析：Spring的容器IOC
* 9. 
...
* 4. 数据库 （第 01 篇）精讲： 悲观锁与乐观锁
* 5. 数据库 （第 01 篇）精讲： SQL优化
...
* 4. 分布式系统 （第 01 篇） 精讲：CAP定理与Base理论
* 5. 分布式系统 （第 01 篇） 精讲：2PC协议和3PC协议
* 6. 分布式系统 （第 01 篇） 精讲：TCC事务补偿机制（柔性事务方案）
* 7. 分布式系统 （第 01 篇） 精讲：什么是Zookeeper？
* 8. 分布式系统 （第 01 篇） 精讲：设计分布式锁
* 9. 分布式系统 （第 01 篇） 精讲：分布式session/token一致性设计
* 10. 分布式系统 （第 01 篇） 精讲：分布式事务
* 11. 分布式系统 （第 01 篇） 精讲：分布式缓存
* 12. 分布式系统 （第 01 篇） 精讲：分布式高并发的支持与控制
* 13. 分布式系统 （第 01 篇） 精讲：分布式下悲观锁和乐观锁的实现
* 15. 分布式系统 （第 01 篇） 精讲：分布式支付框架的实现
...
* 3. 微服务 （第 01 篇） 精讲：服务拆分
* 4. 微服务 （第 01 篇） 精讲：微服务的核心 -- 服务治理（服务注册与发现中心）
* 5. 微服务 （第 01 篇） 精讲：网关Gateway
* 6. 微服务 （第 01 篇） 精讲：路由Routing
* 7. 微服务 （第 01 篇） 精讲：负载均衡算法
* 8. 微服务 （第 01 篇） 精讲：服务熔断、服务隔离、服务限流、服务降级、快速失败
* 9. 微服务 （第 01 篇） 精讲：SpringCloud
...
- 3. 高并发与高可用 （第 01 篇） 精讲：如何防止网络抖动产生的重复建单
- 4. 高并发与高可用 （第 01 篇） 精讲：如何度过服务器重启后的连接风暴
- 5. 高并发与高可用 （第 01 篇） 精讲：数据持久化 + ACK + 补偿重试+请求幂等性+防重设计
- 6. 高并发与高可用 （第 01 篇） 精讲： 抢红包系统实现
- 7. 高并发与高可用 （第 01 篇） 精讲：
